...
aliases:
  - wiki/source-promptingguide-applications-function-calling
---

<aside class="kb-header kb-type-source-summary" aria-label="Page information">
<p class="kb-type">Reading note</p>
<p class="kb-summary">Application-focused primer on function calling as reliable LLM→tool/API bridging.</p>
<p class="kb-provenance">DAIR.AI (Elvis Saravia et al.), 2023-08-15. <a href="https://raw.githubusercontent.com/dair-ai/Prompt-Engineering-Guide/main/pages/applications/function_calling.en.mdx">Original source</a></p>
