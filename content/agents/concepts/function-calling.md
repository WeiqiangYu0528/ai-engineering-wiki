...
<p class="kb-summary">Function Calling (or Tool Calling) is the core LLM capability enabling AI Agents to interact with external tools, APIs, and knowledge bases by emitting structured invocations (JSON with name + arguments) that developer…</p>
...
<nav class="kb-next" aria-label="Next in this reading path"><p>Next in this reading path: <a href="/agents/concepts/model-context-protocol">Model Context Protocol</a></p></nav>
