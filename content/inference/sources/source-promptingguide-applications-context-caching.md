...
aliases:
  - wiki/source-promptingguide-applications-context-caching
---

<aside class="kb-header kb-type-source-summary" aria-label="Page information">
<p class="kb-type">Reading note</p>
<p class="kb-summary">Hands-on guide to Gemini 1.5 Pro/Flash context caching (caching.CachedContent.create() via generativeai library) for low-latency querying over large static corpora.</p>
<p class="kb-provenance">DAIR.AI (Elvis Saravia et al.), 2024-06-01. <a href="https://raw.githubusercontent.com/dair-ai/Prompt-Engineering-Guide/main/pages/applications/context-caching.en.mdx">Original source</a></p>
