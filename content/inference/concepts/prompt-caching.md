...
<p class="kb-summary">Prompt Caching is Anthropic's prefix-caching primitive for the Claude API that reuses the KV and prefix state for static prompt prefixes marked with cachecontrol, cutting cost to 10% and latency on cache hits.</p>
