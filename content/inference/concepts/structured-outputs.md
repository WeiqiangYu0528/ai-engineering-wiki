...
<p class="kb-summary">Structured Outputs is OpenAI's JSON Schema-constrained generation feature that guarantees model responses adhere to a supplied schema (strict:true), ensuring no required key is omitted and no enum is hallucinated.</p>
