...
<p class="kb-summary">In-Context Recall is the ability of an LLM to surface a specific fact ("needle") embedded at varying depths within a long prompt ("haystack") and varying total lengths.</p>
