...
<p class="kb-summary">LLM Models Overview consolidates the DAIR Prompt Engineering Guide's Models section — a catalog of 100+ LLMs (Feb 2023–mid-2025) plus deep dives on ChatGPT (gpt-3.5-turbo), GPT-4/Turbo/Vision, LLaMA/ Llama 3, Claude 3…</p>
<p class="kb-trust kb-status-draft"><a href="/trust">Draft - written, claims not checked against the source</a></p>
<nav class="kb-related" aria-label="Related concepts"><ul><li><a href="/llm-fundamentals/entities/openai">OpenAI</a></li><li><a href="/llm-fundamentals/entities/anthropic">Anthropic</a></li><li><a href="/llm-fundamentals/entities/google-research">Google Research</a></li><li><a href="/llm-fundamentals/entities/deepmind">DeepMind</a></li><li><a href="/llm-fundamentals/entities/chinchilla">Chinchilla</a></li><li><a href="/llm-fundamentals/concepts/scaling-laws">Scaling Laws</a></li><li><a href="/llm-fundamentals/concepts/pretraining">Pretraining</a></li><li><a href="/prompt-engineering/concepts/prompt-engineering">Prompt Engineering</a></li><li><a href="/inference/concepts/inference">LLM Inference</a></li></ul></nav>
<nav class="kb-sources" aria-label="Sources cited"><ul><li><a href="/open-source/sources/source-promptingguide-models-collection">LLM Collection — Prompt Engineering Guide (DAIR.AI) Models</a></li><li><a href="/prompt-engineering/sources/source-promptingguide-models-chatgpt">ChatGPT Prompt Engineering — Prompt Engineering Guide (DAIR.AI) Models</a></li><li><a href="/llm-fundamentals/sources/source-promptingguide-models-gpt-4">GPT-4 — Prompt Engineering Guide (DAIR.AI) Models</a></li><li><a href="/open-source/sources/source-promptingguide-models-llama-3">Llama 3 — Prompt Engineering Guide (DAIR.AI) Models</a></li><li><a href="/open-source/sources/source-promptingguide-models-llama">LLaMA: Open and Efficient Foundation Language Models — Prompt Engineering Guide (DAIR.AI) Models</a></li><li><a href="/llm-fundamentals/sources/source-promptingguide-models-gemini">Getting Started with Gemini — Prompt Engineering Guide (DAIR.AI) Models</a></li><li><a href="/llm-fundamentals/sources/source-promptingguide-models-claude-3">Claude 3 — Prompt Engineering Guide (DAIR.AI) Models</a></li><li><a href="/llm-fundamentals/sources/source-promptingguide-models-hub">Models Hub — ChatGPT, Claude 3, and Gemini Overview</a></li></ul></nav>
