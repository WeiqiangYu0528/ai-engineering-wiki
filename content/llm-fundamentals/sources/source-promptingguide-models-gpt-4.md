...
aliases:
  - wiki/source-promptingguide-models-gpt-4
---

<aside class="kb-header kb-type-source-summary" aria-label="Page information">
<p class="kb-type">Reading note</p>
<p class="kb-summary">Comprehensive model guide to GPT-4 (incl. GPT-4 Turbo / Vision) as a large multimodal (text+image in → text out) frontier.</p>
<p class="kb-provenance">DAIR.AI (Elvis Saravia et al.), 2023-04-15. <a href="https://raw.githubusercontent.com/dair-ai/Prompt-Engineering-Guide/main/pages/models/gpt-4.en.mdx">Original source</a></p>
