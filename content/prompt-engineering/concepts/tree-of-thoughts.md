...
<p class="kb-summary">Tree of Thoughts (ToT) (Yao et al. 2023 https://arxiv.org/abs/2305.10601; Long 2023 https://arxiv.org/abs/2305.08291) generalizes Chain-of-Thought Prompting from a linear chain to a searchable tree where each node is a…</p>
...
<nav class="kb-next" aria-label="Next in this reading path"><p>Next in this reading path: <a href="/prompt-engineering/concepts/react">ReAct (Reasoning + Acting)</a></p></nav>
